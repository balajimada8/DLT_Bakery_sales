...
The 'DLT_Bakery_sales' project was generated by using the default-python template.
...
3. To deploy a development copy of this project, type:
    ...
    `[dev yourname] DLT_Bakery_sales_job` to your workspace.
...
4. Similarly, to deploy a production copy, type:
   ...
   (defined in resources/DLT_Bakery_sales.job.yml). The schedule
